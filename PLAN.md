...
This file held the v1 build plan: an offline-first prototype on an invented B2B webinar, with HubSpot, Clay, n8n
and the LLM calls all behind flags because no company had been named yet.

v1 was submitted and the reviewer's verdict was that it did not follow the case study. v2 is a rebuild against a
