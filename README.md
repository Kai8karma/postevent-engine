...
- **M4's engagement stream is seeded.** Opens, clicks, page views, form fills and lifecycle changes did not happen on
  ...
  "2026-09-21": 39}`. The 39 on 2026-09-21 were all written by this pipeline that afternoon — 32 by the M1 push
  (`source_mix.hubspot_history`) and 7 by the seed phase (`source_mix.seeded`). The 40th is older: the speaker
...
- M4 — all four phases run live against the HubSpot test portal: seed 16 contacts / 73 engagement events / 12
  ...
  HTTP 200, analyze 4/4 completions with 5 validator agreements and 2 disagreements recorded. Plus 37 zero-network
